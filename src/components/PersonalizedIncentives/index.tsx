    ...
    <S.Content>
      ...
      <S.IncentivesFooter>
        <S.IncentivesFooterContent>
          ...
          Congress, the rebate programs will end once their initial IRA funding
          is exhausted. Tax credits can only be used to offset your federal
          taxes owed, which we estimate but do not know.
        </S.IncentivesFooterContent>
        <S.IncentivesFooterContent>
