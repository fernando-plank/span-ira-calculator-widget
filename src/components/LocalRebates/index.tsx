      ...
      <div>
        ...
        <Accordion icon={'Plus'} title={'Hawai’i'}>
          ...
          <S.BodyWrapper>
            <S.BodyContent>
              <S.BodyText>
                <b>Shifted Energy</b> customers can have the costs of SPAN Panel
                covered, plus up to $4,000 for install when they agree to share
                SPAN Panel data and control with Shifted Energy.
              </S.BodyText>
              <S.LearnMoreButton>Learn more</S.LearnMoreButton>
            </S.BodyContent>
            <S.BodyContent>
